...
- [대문자와 소문자](https://school.programmers.co.kr/learn/courses/30/lessons/120893) (`120893`) — 글자마다 조건을 확인하고 다른 형태로 바꿉니다.
- [암호 해독](https://school.programmers.co.kr/learn/courses/30/lessons/120892) (`120892`) — 위치 조건에 맞는 글자만 골라 새 문자열을 만듭니다.
